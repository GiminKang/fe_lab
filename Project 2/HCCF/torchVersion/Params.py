...
def ParseArgs():
	...
	parser.add_argument('--tstBat', default=4550, type=int, help='number of users in a testing batch')
	parser.add_argument('--reg', default=1e-7, type=float, help='weight decay regularizer')
	parser.add_argument('--epoch', default=100, type=int, help='number of epochs')
	parser.add_argument('--decay', default=0.96, type=float, help='weight decay rate')
	parser.add_argument('--save_path', default='stocks', help='file name to save model and training record')
	...
	parser.add_argument('--load_model', default='tem', help='model name to load')
	...
	parser.add_argument('--data', default='stocks', type=str, help='name of dataset')
